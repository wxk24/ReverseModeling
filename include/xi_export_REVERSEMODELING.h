 ...
 * @库作者:
		编绎动态库: 需定义宏 XI_DLL_REVERSEMODELING
		编绎静态库: 无需任何定义
		编绎exe: 无需任何定义

 * @库使用者:
		使用动态库: 需定义宏 XI_USE_DLL_REVERSEMODELING
		使用静态库: 无需任何定义
		使用exe: 无需任何定义
 */
...
#ifdef XI_DLL_REVERSEMODELING
#	ifndef XI_EXPORT_REVERSEMODELING
#		define XI_EXPORT_REVERSEMODELING XI_DECL_EXPORT
#	endif
#else
#	ifdef XI_USE_DLL_REVERSEMODELING
#		ifndef XI_EXPORT_REVERSEMODELING
#			define XI_EXPORT_REVERSEMODELING XI_DECL_IMPORT
#		endif
#	else
#		ifndef XI_EXPORT_REVERSEMODELING
#			define XI_EXPORT_REVERSEMODELING
#		endif
#	endif
#endif
